 ...
 */
function wp_show_if_front_page( $cmb ) {
 ...
 * @return bool              True if metabox should show
 */
function wp_hide_if_no_cats( $field ) {
 ...
 */
function wp_render_row_cb( $field_args, $field ) {
 ...
 * @param  CMB2_Field $field      The field object.
 */
function wp_display_text_small_column( $field_args, $field ) {
	?>
 ...
 * @param  CMB2_Field $field      Field object.
 */
function wp_before_row_if_2( $field_args, $field ) {
...
add_action( 'cmb2_admin_init', 'wp_register_demo_metabox' );
/**
 * Hook in and add a demo metabox. Can only happen on the 'cmb2_admin_init' or 'cmb2_init' hook.
 */
function wp_register_demo_metabox() {
	$prefix = 'wp_demo_';
	...
	$cmb_demo = new_cmb2_box( array(
		...
		// 'show_on_cb' => 'wp_show_if_front_page', // function should return a bool value
		// 'context'    => 'normal',
		// 'priority'   => 'high',
		...
		// 'classes_cb' => 'wp_add_some_classes', // Add classes through a callback.
	) );
	...
	$cmb_demo->add_field( array(
		...
		'id'         => $prefix . 'text',
		'type'       => 'text',
		'show_on_cb' => 'wp_hide_if_no_cats', // function should return a bool value
	...
	$cmb_demo->add_field( array(
		...
		// );
		// 'display_cb' => 'wp_display_text_small_column', // Output the display of the column values through a callback.
	) );
	...
	$cmb_demo->add_field( array(
		...
		'type' => 'text',
		'render_row_cb' => 'wp_render_row_cb',
	) );
	...
	$cmb_demo->add_field( array(
		...
		'type'         => 'text',
		'before_row'   => 'wp_before_row_if_2', // callback.
...
add_action( 'cmb2_admin_init', 'wp_register_about_page_metabox' );
/**
 * Hook in and add a metabox that only appears on the 'About' page
 */
function wp_register_about_page_metabox() {
	$prefix = 'wp_about_';
...
add_action( 'cmb2_admin_init', 'wp_register_user_profile_metabox' );
/**
 * Hook in and add a metabox to add fields to the user profile pages
 */
function wp_register_user_profile_metabox() {
	$prefix = 'wp_user_';
...
add_action( 'cmb2_admin_init', 'wp_register_taxonomy_metabox' );
/**
 * Hook in and add a metabox to add fields to taxonomy terms
 */
function wp_register_taxonomy_metabox() {
	$prefix = 'wp_term_';
...
add_action( 'cmb2_admin_init', 'wp_register_theme_options_metabox' );
/**
 * Hook in and register a metabox to handle a theme options page and adds a menu item.
 */
function wp_register_theme_options_metabox() {

	/**
	 * Registers options page menu item and form.
	 */
	$cmb_options = new_cmb2_box( array(
		'id'           => 'wp_theme_options_page',
		...
		'option_key'      => 'wp_theme_options', // The option key and admin menu page slug.
		...
		// 'message_cb'      => 'wp_options_page_message_callback',
	) );
 ...
 * }
 */
function wp_options_page_message_callback( $cmb, $args ) {
 ...
 */
function wp_limit_rest_view_to_logged_in_users( $is_allowed, $cmb_controller ) {
...
add_action( 'cmb2_init', 'wp_register_rest_api_box' );
/**
 ...
 */
function wp_register_rest_api_box() {
	$prefix = 'wp_rest_';
	...
	$cmb_rest = new_cmb2_box( array(
		...
		// 'get_box_permissions_check_cb' => 'wp_limit_rest_view_to_logged_in_users',
	) );
