...
function acf_form_data( $args = array() ) {
	...
	global $wpdb;
	$session = $wpdb->get_results( 'SELECT uniq_number FROM wp_sessii WHERE state = 1', OBJECT );

//	var_dump($session[0]->uniq_number);
	...
	<div id="acf-form-data" class="acf-hidden">
		...
		<input type="hidden" name="id_bid" value=<?php echo $session[0]->uniq_number; ?> />
