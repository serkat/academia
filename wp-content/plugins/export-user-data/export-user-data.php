...
//            load_textdomain( 'export-user-data', WP_LANG_DIR.'/plugins/export-user-data-'.$locale.'.mo' );
            load_textdomain( 'export-user-data', WP_LANG_DIR.'/plugins/export-user-data-ru_RU.mo' );
        ...
        */
        ...
        public function generate_data()
        {
            ...
            // export method ? ##
            $export_method = 'csv'; // default to Excel export ##
...
?>
                <tr valign="top">
                    <th scope="row">
                        ...
                        <p class="filter" style="margin: 10px 0 0;">
                            <?php _e('Выберите', 'export-user-data'); ?>: <a href="#" class="select-all"><?php _e('All', 'export-user-data'); ?></a> | <a href="#" class="select-none"><?php _e('None', 'export-user-data'); ?></a>
                        </p>
                    </th>
                    <td>
